...
const FriendAddModalView = (props: FriendAddModalViewProps) => {
    ...
    const [friendsResource] = createResource(() => hasAdded(), () => http.Channel.addFriend("prime#324"));
    ...
    return (
        <>
            ...
            <form class="w-full max-w-sm">
                ...
                <Button text="Add" isLoading={friendsResource.loading} callback={() => setHasAdded(true)} />
            </form>
        </>
    );
};
